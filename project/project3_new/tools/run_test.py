    ...
    def run(self, pipelined=False):
        ...
        try:
            with output_path.open("w") as output_file:
                ...
                proc.wait()
            ########
            # line_to_insert = "Test,ALUResult,InputA,InputB,ALUSel"
            # line_to_insert ="Test,ra,sp,t0,t1,t2,s0,s1,a0,ReadData1,ReadData2,ReadIndex1,ReadIndex2,WriteIndex,RegWEn,WriteData"
            # line_to_insert = "Test,Immediate,Instruction,ImmSel"
            # line_to_insert = "Test,BrEq,BrLt,BrData1,BrData2,BrUn"
            # line_to_insert = "ra,sp,t0,t1,t2,s0,s1,a0,RequestedAddress,RequestedInstruction,TimeStep"
            # line_to_insert = "Test,Immediate,Instruction,ImmSel"
            # line_to_insert = "ra,sp,t0,t1,t2,s0,s1,a0,RequestedAddress,RequestedInstruction,TimeStep"
            # line_to_insert = "Test,DataToReg,Instruction,MemAddress,DataFromMem"
            # line_to_insert ='Test,MemWriteMask,DataToMem,Instruction,MemAddress,DataFromReg,MemWEn'
            # line_to_insert = "ra,sp,t0,t1,t2,s0,s1,a0,RequestedAddress,RequestedInstruction,TimeStep"
            # line_to_insert = "Test,Immediate,Instruction,ImmSel"
            # line_to_insert = 'Test,Immediate,Instruction,ImmSel'
            # line_to_insert = 'ra,sp,t0,t1,t2,s0,s1,a0,RequestedAddress,RequestedInstruction,TimeStep'
            with open(output_path, 'r', encoding='utf-8') as file:
                lines = [l.replace("\t",",").replace(" ","") for l in file.readlines()]
            # 在第一行插入新行
